...
def check_parity():
    ...
    no_translation_needed = {'victim-cross-reference-english.md', 'groff-investigation-english.md', 'groff-prosecution-gap-english.md', 'proffer-landscape-english.md', 'complete-findings-english.md'}
